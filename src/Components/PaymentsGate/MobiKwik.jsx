...
import mobik from '../../Images/12.jpeg';
import { AiOutlineSwap } from "react-icons/ai";
import { useState } from "react"
import { Link } from "react-router-dom";

export default function MobiKwik() {
                ...
                <div style={{ width: "90%", height: "93%" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "10px", height: "35%" }}>
                        <div style={{ width: "94%", height: "100%" }}>
                            <div style={{ background: "#5E5ED6", width: "100%", height: "45%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                <div style={{ width: "94%", height: "65%", display: "flex" }}>
                                    <div style={{ width: "20%", height: "100%" }}>
                                        <img src={mobik} style={{ height: '100%', width: "100%" }} />
                                    </div>
                                    ...
                                    <div onClick={openMobiKwik} style={{ width: "35%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                        <div style={{ background: "#2731F5", borderRadius: "9px", width: "60%", height: "50%", display: "flex", alignItems: "center", justifyContent: "center" }}><p style={{ margin: "0" }}>Go</p></div>
                                    </div>
                                </div>
                            </div>
